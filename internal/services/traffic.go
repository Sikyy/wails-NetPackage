...
// 处理数据包流量
func HandleTraffic(packet gopacket.Packet, clientIP string, sessioninfo *define.SessionInfo, sessionMap *sync.Map) {
	//防止空指针
	if sessioninfo == nil {
		return
	}
...
func UpdateTraffic(sessionInfo *define.SessionInfo, byteCount float64, isUpTraffic bool) {
